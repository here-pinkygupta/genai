    ...
    return (
        <div className="interview-page">
            <div className="interview-layout">
                ...
                {/* ── Left Nav (single column — matches grid: 220px) ── */}
                ...
                {/* ── Center Content (single main — matches grid: 1fr) ── */}
                ...
                {/* ── Right Sidebar (single aside — matches grid: 250px) ── */}
                <aside className="interview-sidebar">
                    <div className="match-score">
                        ...
                        <p className="match-score__sub">
                            {matchScore >= 80 ? "Strong Match" : "Moderate Match"}
                        </p>
                    </div>
                    ...
                    <div className="skill-gaps">
                        <span className="skill-gaps__label">Skill Gaps</span>
                        <div className="skill-gaps__list">
                            {(report.skillsGap ?? []).map((gap, index) => (
                                <span
                                    key={index}
